    ...
    <div v-loading="loadingData" class="content">
      ...
      >
        <div
          ...
          <!-- listReadable true 不可勾选   false可选  -->
          <div><el-checkbox v-model="item.listChecked" :disabled="item.disabled || item.listReadable" @change="checkChange(1)"/></div>
          <div><el-checkbox v-model="item.checked" :disabled="item.disabled" @change="checkChange(2)"/></div>
        </div>
      </draggable>
    </div>
