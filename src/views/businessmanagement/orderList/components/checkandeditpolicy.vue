        ...
        <div class="policyitem">
          ...
          <div id="policyinfo" style="padding-top: 10px;">
            ...
            <app-form-group>
              ...
              <app-form-item :span="6" :label="policyExt.organizationName"/>
              ...
              <app-form-item :span="6" :label="policyExt.userName"/>
            ...
            <app-form-group>
              ...
              <app-form-item v-if="!isEdit" :span="6" :formatter="policyStatusFormatter" :label="policyExt.policyStatus"/>
              <app-form-item v-if="isEdit" :span="6" no-padding label="@">
                <my-select v-model="policyExt.policyStatus" prop="policyStatus" size="mini" style="width: 100%;" @change="onPolicyStatus">
                  <el-option
              ...
              <app-form-item v-if="policyExt.policyStatus !== 8" :span="6" :label="formatTime(policyExt.policyTime)"/>
              <app-form-item v-if="policyExt.policyStatus === 8" :span="6" no-padding label="@">
                <el-date-picker
              ...
              <app-form-item :span="6" :label="policyExt.inputTime"/>
            </app-form-group>
            <app-form-group>
              <app-form-item :span="2" label="同步状态：" background/>
              <app-form-item :span="22" label="@">
                <el-button
                  :type="btnType"
            ...
            <app-form-group>
              ...
              <app-form-item v-if="policyExt.policyStatus !== 8" :span="6" :label="policyExt.vciPolicyNo"/>
              <app-form-item v-if="policyExt.policyStatus === 8" :span="6" no-padding label="@">
                <my-input v-model="policyExt.vciPolicyNo" size="mini" style="width: 100%;"/>
              </app-form-item>
              ...
              <app-form-item :span="6" :label="policyExt.insureTime"/>
            </app-form-group>
            <app-form-group>
            ...
            <app-form-group>
              ...
              <app-form-item v-if="policyExt.policyStatus !== 8" :span="6" :labell="policyExt.tciPolicyNo"/>
              <app-form-item v-if="policyExt.policyStatus === 8" :span="6" no-padding label="@">
                <my-input v-model="policyExt.tciPolicyNo" size="mini" style="width: 100%;"/>
              </app-form-item>
...
<script>
import RiskInfo from '@/views/businessmanagement/orderList/components/riskInfo'
